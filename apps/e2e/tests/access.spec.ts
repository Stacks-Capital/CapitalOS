...
const TABS = ["Portfolio", "Earn", "Borrow", "Swap", "Risk", "Markets", "Activity"];
...
test("every screen passes an accessibility scan with no serious or critical issues", async ({ page }) => {
  await signIn(page);
